      ...
      <section class="section container productSec is-desktop">
        ...
        <div class="showProduct columns is-desktop">
            ...
            <div class="productShowcase column is-three-quarters is-offset-one-quarter">
                <div class='columns is-desktop items'>
                <?php
                    include "cms/db.php";
                    db_connect();
						...
						$numberOfRows = mysqli_num_rows($queryResult);
						 ...
						 if($numberOfRows > 0) {
                             while( $rowArray = mysqli_fetch_assoc($queryResult)){
                                ...
                                echo    "<div class='eachProduct column is-one-third'>";
                                echo        "<div class='productImage'><img class='eachProductImg' src='cms/".$img."' data-img='cms/".$img."'></div>";
                                ...
                                echo            "</div>";
                                echo            "<h2 data-title=".$name.">".$name."</h2>";
                                echo            "<h5 data-price=".$price.">".$price." CAD</h5>";
                                echo            "<p data-description=".$description.">".$description."</p>";
                                echo        "</div>"; //end of productDetail section
                                echo        "<div class='cartButton'>";
                                echo            "<button id='addCart'><a class='button is-medium'>Add Cart</a></button>";
